...
/**
 * generateStaticParams is a function used to define the paths that should be pre-rendered at build time when using static site generation (SSG). This function is particularly useful when you have dynamic routes and want to generate static pages for each dynamic route at build time.
 *
 * You provide it with a function that returns an array of objects representing the dynamic paths you want to pre-render.
 */
